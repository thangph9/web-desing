              ...
              >
                <div className={styles['order-summary__card-block___1hCkc']}>
                  ...
                  <div>
                    <div
                      className={
                        styles['row__row___2roCA'] + ' ' + styles['order-summary__subtotal___1-kE1']
                      }
                    >
                    ...
                    <div
                      className={
                        styles['row__row___2roCA'] + ' ' + styles['order-summary__shipping___14XDr']
                      }
                    >
                    ...
                    <div>
                      <a href="/auth/signin?redirect=/checkout">Đăng nhập để sử dụng mã giảm giá</a>
                    </div>
                    <hr />
                    <div
              ...
              <div className={styles['address__card___2il6c']}>
                <div className={styles['address__card-block___gCJQ8']}>
                  <div className={styles['an-address__address___yB6sO']}>
                    ...
                    <div>
                      <div>
                        <span>nguyen tri</span>
                        <span className={styles['an-address__dot-seperator___1_vim']}>•</span>
                        <span>0972511554</span>
                      </div>
                      <div>Ha Noi, Huyện Hồng Ngự, Đồng Tháp</div>
                    </div>
                  </div>
                </div>
              </div>
              <div className={styles['order-details__card___x9UEx']}>
                <div className={styles['order-details__card-block___3EZL6']}>
                  <h4 className={styles['order-details__card-title___1HHwX']}>
                    <span>Đơn hàng của bạn (1 Sản phẩm)</span>
                  ...
                  <div>
                    ...
                    >
                      <div className={styles['order-details__image___2nFML']}>
                        <img src="https://leflair-assets.storage.googleapis.com/5ae983e6e613f0000fdbce89.jpg" />
                      </div>
                      <div className={styles['order-details__info___3ESiE']}>
                        <div className={styles['order-details__title___rODtC']}>
                          Túi Clutch Khóa Kéo
                        </div>
                        <div className={styles['order-details__desc___3xcNy']}>Số lượng: 1</div>
                        <div className={styles['order-details__desc___3xcNy']}>
                          Giá: <span className>479.000₫</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              >
                <div className={styles['payment__card-block___3Uvg0']}>
                  ...
                  <div className={styles['payment__payment-options___ZrwiQ']}>
                    ...
                    >
                      <div className={styles['cod__heading___uvWgz clearfix']}>
                        <label
                          className={
                        ...
                        >
                          <input
                            ...
                            defaultValue="on"
                          />
                          <span className={styles['cod__custom-control-indicator___2d8Dw']} />
                      ...
                      <div className={styles['cc__heading___3PENY']}>
                        ...
                        >
                          <input
                            ...
                            defaultValue="on"
                          />
                          <span className={styles['cc__custom-control-indicator___1fCjJ']} />
                          ...
                          >
                            <div>
                              <form noValidate autoComplete="on">
                                ...
                                <div
                                  className={
                                    styles['row__row___2roCA credit-card-form__form-group___BZuCA']
                                  }
                                >
