    ...
    return (
      ...
      >
        ...
        >
          <div>
            <div
              style={!data.avatar ? { background: 'gainsboro', height: 'auto' } : {}}
              className={
            ...
            >
              <img
                ...
                src={
                  data.avatar
                    ? `/images/ft/${data.avatar.replace(/\-/g, '')}`
          ...
          <div className={styles['sale__sale___1auiY']}>
            <div className={styles['sale__sale-header___1lQxA']}>
              ...
              >
                ...
                >
                  <div className={styles['row__row___2roCA']}>
                    {this.renderTotalProduct(globalProduct.length)}
                    <div
                      className={
                        styles['clearfix'] +
                        ' ' +
                ...
                <div className={styles['hidden-md-up'] + ' ' + styles['sale__mobile-data___evUIw']}>
                  ...
                  >
                    Hiện có {globalProduct.length} sản phẩm
                  </div>
                  <span
                    className={
