export default {
  ...
  'menu.listcategory': 'Listcategory',
  'menu.list-order': 'CMS/ListOrder',
  'menu.homebytri': 'HomeByTri',
  'menu.detailtest': 'DetailTest',
  'menu.productbytri':'ProductByTri',
  'menu.listcategorytest':'ListCategoryTest',
  'menu.categorybytri':'CategoryByTri',
  'menu.helpabout':'HelpAbout',
  'menu.forgotpass':'ForgotPass',
  'menu.confirmotp':'ConfirmOtp',
  'menu.changepass':'ChangePass',
  'menu.login':'Login',
  'menu.list-order':'ListOrder',
  'menu.listcategory': 'Listcategory',
